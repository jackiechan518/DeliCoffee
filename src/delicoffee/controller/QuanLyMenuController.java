...
public class QuanLyMenuController {
    ...
    private String[] listColumn = {"STT", "STT", "Tên món", "Số lượng món", "Giá món"};
        ...
        table.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (e.getClickCount() == 2 && table.getSelectedRow() != -1) {
                    ...
                    menu.setSoLuongMon((int) model.getValueAt(selectedRowIndex, 3));
                    menu.setGiaMon((int) model.getValueAt(selectedRowIndex, 4));
